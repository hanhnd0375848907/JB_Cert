...
namespace JBCert
{
    public partial class AddCopiedCertForm : Form
    {
        ...
        public AddCopiedCertForm(int blankCertTypeId)
        {
            InitializeComponent();
        ...
        private void AddCopiedCertForm_Load(object sender, EventArgs e)
        {
            // School
        ...
        private void NextButton_Click(object sender, EventArgs e)
        {
            ...
            SelectCopiedBlankCertForm selectCopiedBlankCertForm = new SelectCopiedBlankCertForm(this, _blankCertTypeId);
            selectCopiedBlankCertForm.ShowDialog();
        }
